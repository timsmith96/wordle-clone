...
const rotatorsGrid = {
  ...
  1: rotators.slice(5, 10),
  2: rotators.slice(10, 15),
  3: rotators.slice(15, 20),
  4: rotators.slice(20, 25),
  5: rotators.slice(25, 30),
};
let gameGrid = {
  0: cells.slice(0, 5),
  1: cells.slice(5, 10),
...
const checkWord = () => {
  ...
  if (filledCells % 5 === 0 && filledCells !== 0) {
    ...
    if (validWords.includes(word)) {
      ...
      gameGrid[currentRow].forEach((cell) => {
        cell.classList.toggle('shake-class');
...
const updateTiles = (obj) => {
  let interval = 500;
  for (let i = 0; i < 5; i++) {
    setTimeout(() => {
      if (obj[i] === 'A') {
        rotatorsGrid[currentRow][i].style.transform += 'rotateX(180deg)';
        gameGrid[currentRow][i].style.transform += 'rotateX(180deg)';
        setTimeout(() => {
          gameGrid[currentRow][i].style.backgroundColor = '#6aaa64';
          gameGrid[currentRow][i].style.color = 'white';
          gameGrid[currentRow][i].style.border = 'none';
        }, 200);
      } else if (obj[i] === 'B') {
        rotatorsGrid[currentRow][i].style.transform += 'rotateX(180deg)';
        gameGrid[currentRow][i].style.transform += 'rotateX(180deg)';
        setTimeout(() => {
          gameGrid[currentRow][i].style.backgroundColor = 'rgb(201, 180, 88)';
          gameGrid[currentRow][i].style.color = 'white';
          gameGrid[currentRow][i].style.border = 'none';
        }, 200);
      } else {
        ...
        gameGrid[currentRow][i].style.transform += 'rotateX(180deg)';
        setTimeout(() => {
          gameGrid[currentRow][i].style.backgroundColor = '#787c7e';
          gameGrid[currentRow][i].style.color = 'white';
          gameGrid[currentRow][i].style.border = 'none';
        }, 200);
      }
